    ...
    Tables: {
      ...
      orders: {
        Row: {
          ...
          cost: number | null
          date_information_complete: string | null
          due_delivery_date: string | null
          delivery_1_date: string | null
          delivery_2_date: string | null
          delivery_3_date: string | null
          delivery_4_date: string | null
          delay_first_delivery: number | null
          delay_first_revision: number
          delay_second_revision: number
        ...
        Relationships: [
          {
            foreignKeyName: "orders_product_name_fkey"
